...
var SearchIcon = function () {
    return (React__default.createElement("svg", { fill: "grey", xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24" },
        React__default.createElement("path", {
            // tslint:disable-next-line:max-line-length
...
var CustomChips = function (props) {
    ...
    var onKeyPress = function (event) {
        ...
        if (event.key === 'Backspace' && tmpTarget.value === '') {
            ...
            if (props.canBeEmpty) { tmpChipsData.pop(); } 
            else if (tmpChipsData.length > 1) { tmpChipsData.pop(); }
    ...
    var renderListItem = function (selected, value, handleSelect) {
        ...
        return (React__default.createElement(SampleListItem, { key: value.id /** fixed this, causing key issue while looping in DOM */, preSelected: chipsData.includes(value), value: value, selected: selected, handleSelect: handleSelect }));
    };
